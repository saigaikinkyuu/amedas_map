...
$.getJSON("https://www.jma.go.jp/bosai/amedas/data/map/"+new Date().getFullYear()+""+("0"+new Date().getMonth()).slice(-2)+""+("0"+new Date().getDate()).slice(-2)+""+("0"+new Date().getHours()).slice(-2)+""+(new Date().getMonth()+"0").slice(0,1)+"000.json", function (datas) {
