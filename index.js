                ...
                for (var key in datas) {
                    ...
                    if (datas[key].temp && num === 1) {
                        ...
                        if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-7")).replace("〜",""))) {
                            var color = "#969696"
                            var rgba = "rgba(150, 150, 150,0.3)"
                        } else if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-6")).substr(0, str.indexOf('〜')))) {
                            var color = "blue"
                            var rgba = "rgba(000,000,200,0.3)"
                        } else if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-5")).substr(0, str.indexOf('〜')))) {
                            var color = "#0096c8"
                            var rgba = "rgba(0, 150, 200,0.3)"
                        } else if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-4")).substr(0, str.indexOf('〜')))) {
                            var color = "#00c800"
                            var rgba = "rgba(0, 200, 0 ,0.3)"
                        } else if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-3")).substr(0, str.indexOf('〜')))) {
                            var color = "yellow"
                            var rgba = "rgba(255,255,0,0.3)"
                        } else if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-2")).substr(0, str.indexOf('〜')))) {
                            var color = "orange"
                            var rgba = "rgba(255,165,0,0.3)"
                        } else if (datas[key].temp[0] <= Number((document.getElementById("inputHanrei1-1")).replace("〜",""))) {
                            var color = "red"
                            var rgba = "rgba(255,0,0,0.3)"
                        } else {
                            var color = "purple"
